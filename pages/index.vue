...
<template>
  <section class="py-24 sm:py-40">
    <div class="max-w-2xl mx-auto px-4 space-y-4 sm:text-center">
      <h2 class="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">
        Shorten Your Links
      </h2>
      <p class="text-muted-foreground text-base sm:text-xl mt-4">
        Make your links shorter and easier to share with our free link
        shortener.
      </p>
      ...
      <div class="flex items-center space-x-4 sm:justify-center">
        ...
        <NuxtLink
          ...
          >Create Short Link</NuxtLink
        >
      </div>
    </div>
  </section>

  <section class="bg-muted py-24 sm:py-40">
    <div class="max-w-3xl mx-auto px-4" id="create">
      <Card>
        <CardHeader>
